...
// 字节跳动语音对话API类型
declare type ByteDanceVoiceDialogApi = (
  config: import("./api/shared/api.bytedance-config").ByteDanceConfig
) => Promise<{
...
interface Window {
  ...
  electron?: {
    ...
    onUpdaterMessage: (callback: (message: any) => void) => () => void;
